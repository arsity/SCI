...
parser.add_argument(
    "--save", type=str, default="EXP/", help="location of the data corpus"
)
...
def main():
    ...
    train_low_data_names = "/home/haopeng/datasets/ExLPose/ExLPose/dark"
    TrainDataset = MemoryFriendlyLoader(
        img_dir=train_low_data_names, task="train"
    )

    test_low_data_names = "/home/haopeng/datasets/ExLPose/ExLPose-OCN/A7M3"
    ...
    for epoch in range(args.epochs):
        model.train()
        losses = []
        for batch_idx, input in enumerate(train_queue):
            total_step += 1
